...
{
    public partial class QueueCheckIn : Form
    {
        bool QRMode = true;
        bool rfidMode = false;
        ...
        void setQueue(string studentID)
        {
            ...
            string query = "INSERT INTO queueTable (studentID) VALUES (@studentID)";
